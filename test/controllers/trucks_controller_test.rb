...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { capacity: @truck.capacity, height: @truck.height, position_lat: @truck.position_lat, position_lon: @truck.position_lon } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { capacity: @truck.capacity, height: @truck.height, position_lat: @truck.position_lat, position_lon: @truck.position_lon } }
